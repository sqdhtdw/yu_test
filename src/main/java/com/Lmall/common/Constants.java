...
public class Constants {
    public final static String FILE_UPLOAD_DIC = "C:\\Users\\yu\\Desktop\\upload\\";//上传文件的默认url前缀，根据部署设置自行修改
    //public final static String FILE_UPLOAD_DIC = "D:\\upload\\";//涉及图片的部分的修改：上传文件的默认url前缀，根据部署设置自行修改
